"""MTF for simple figures
M.Y. (June 23, 2023): This code is accompanied by some comments, which can be found below.

MTF ignores phase effects but is often equivalent to the OTF.
MTF is the Fourier transform of the point spread function in normal operation.
However, for slanted edge targeted MTF calculations, we use LSF rather than PSF.
This is because we assume LSF is a slanted cross-section of PSF.
The derivative of the edge spread function (ESF) can be used to calculate LSF.
"""
